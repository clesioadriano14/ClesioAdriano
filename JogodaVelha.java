...
public class JogodaVelha extends javax.swing.JFrame {
    ...
    public void Vencedor(String JogadorVencedor) {
        ...
        if(JogadorVencedor.equals("Empate")){
            JOptionPane.showMessageDialog(JogodaVelha.this, "Empatou, vamos pra próxima!");
            JogosEmpatados++;
            NumeroDeEmpates.setText("Número de empates: "+ JogosEmpatados);
            LimparCampos();
        }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(B2, javax.swing.GroupLayout.PREFERRED_SIZE, 9, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(B3)
